...
const sha256Hex = (data: Uint8Array<ArrayBuffer>) =>
  Effect.map(
...
const hmacSign = (key: Uint8Array<ArrayBuffer>, data: Uint8Array<ArrayBuffer>) =>
  Effect.promise(() =>
    crypto.subtle
...
const hmacHex = (key: Uint8Array<ArrayBuffer>, data: Uint8Array<ArrayBuffer>) =>
